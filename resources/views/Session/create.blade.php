                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="capacity" type="number" class="form-control @error('capacity') is-invalid @enderror" placeholder="25" min="1" max="25"
                                    value="{{ old('capacity') }}" />
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            <a href="{{ route('sessions.index') }}" class="btn btn-outline">
